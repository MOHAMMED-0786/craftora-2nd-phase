...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary text-primary-foreground hover:bg-primary/90 focus:ring-primary shadow-soft hover:shadow-warm',
      ...
      accent: 'bg-accent text-accent-foreground hover:bg-accent/90 focus:ring-accent shadow-soft'
    };
